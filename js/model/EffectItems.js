 ...
 * loading - Initial state before the effect is added by the user by clicking the Flatlist item. From NONE, it will go to LOADED or LOADERROR when the user tries to add this effect
 * postProcessEffect - Video post process effect to apply to the AR frames in the scene
 * icon_img - the icon that will be shown on the Flatlist at the bottom for this effect
