...
// change effect selection in the Effects Flatlist (changes which effect has pink border around it)
function modifyEffectSelection(state = [], action) {
  switch (action.type) {
    case 'TOGGLE_EFFECT_SELECTED':
      var effectToggleArray = [];
      // for each effect in the Flatlist, set selected = false for everything, except for the selected index (action.index)
