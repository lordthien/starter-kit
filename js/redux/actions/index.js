...
// action to select model at index, in the Flatlist from data model at path: js/model/ModelItems.js
...
// action to select effect at index, in the Flatlist from data model at path: js/model/EffectItems.js
...
// action to switch Flatlist to show Objects, Effects or Portals
...
// action to change state of individual Flatlist items between NONE, LOADING, ERROR, LOADED (path: js/redux/LoadingStateConstants.js)
...
// action to change state of individual Flatlist items to determine while item is clicked -> for triggering Flatlist animations
